...
---------
 ...
 - Make a local backup (-v or -vv will increase the verbosity):
        ...
        $ bup index ~/Desktop
        $ bup save -n user-desktop ~/Desktop

 - Restore a local backup to /tmp:

		$ bup ls user-desktop
        2015-10-17-210132@  latest@ 
        $ bup ls -l user-desktop/latest/home/<user>/Desktop
        ...
        file 1
        file 2
        file 3
        ...
        $ bup restore -C /tmp user-desktop/latest
        Restoring: 41, done.
		$ cd /tmp/latest/home/<user>/Desktop
        $ ls -l
        ...
        file 1
        file 2
